...
class CoursesListPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.course_title: Locator = page.get_by_test_id('course-widget-title-text')
        self.course_image: Locator = page.get_by_test_id('course-preview-image')
        self.course_max_score_text: Locator = page.get_by_test_id('course-max-score-info-row-view-text')
        self.course_min_score_text: Locator = page.get_by_test_id('course-min-score-info-row-view-text')
        self.course_estimated_time_text: Locator = page.get_by_test_id('course-estimated-time-info-row-view-text')

        self.course_menu_button: Locator = page.get_by_test_id('course-view-menu-button')
        self.course_edit_menu_item: Locator = page.get_by_test_id('course-view-edit-menu-item')
        self.course_delete_menu_item: Locator = page.get_by_test_id('course-view-delete-menu-item')

        self.empty_view_icon: Locator = page.get_by_test_id('courses-list-empty-view-icon')
        self.empty_view_title: Locator = page.get_by_test_id('courses-list-empty-view-title-text')
        self.empty_view_description: Locator = page.get_by_test_id('courses-list-empty-view-description-text')
